...
async def notification_sheduled(bot: Bot, session):
    ...
    text = ('Prizm Exchange\n\n'
            ...
            f'Лимит руб: {best_order_to_buy.min_limit_rub} - {best_order_to_buy.max_limit_rub} руб\n'
            f'Лимит PZM: {best_order_to_buy.min_limit} - {best_order_to_buy.max_limit} PZM\n'
            ...
            f'Лимит руб: {best_order_to_sell.min_limit_rub} - {best_order_to_sell.max_limit_rub} руб\n'
            f'Лимит PZM: {best_order_to_sell.min_limit} - {best_order_to_sell.max_limit} PZM\n'
